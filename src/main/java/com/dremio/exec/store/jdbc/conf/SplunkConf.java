...
@SourceType(value = "SplunkARP", label = "Splunk",uiConfig = "splunk-layout.json")
public class SplunkConf extends AbstractArpConf<SplunkConf> {
  private static final String ARP_FILENAME = "arp/implementation/splunk-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.splunk.SplunkDriver";
